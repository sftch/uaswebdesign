...
<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        <h2 class="text-2xl font-semibold leading-tight">Add New Contact</h2>
        ...
        <div class="mt-6">
            ...
            <form action="{{ route('contacts.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="company" id="company" value="{{ old('company') }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('contacts.index') }}" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
                        Cancel
                    </a>
                </div>
            </form>
